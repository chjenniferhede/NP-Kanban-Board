  ...
  return (
    <div className="flex items-center gap-2">
      <div className="relative">
        ...
        <h1 className="project-title invisible whitespace-pre">{draft || "My Project"}</h1>
        {editing ? (
          <input
            ref={inputRef}
            value={draft}
            ...
            className="absolute inset-0 project-title bg-transparent border-none outline-none w-full"
          />
        ) : (
          <h1 className="absolute inset-0 project-title">{title}</h1>
        )}
      </div>
      <button
        onClick={startEdit}
